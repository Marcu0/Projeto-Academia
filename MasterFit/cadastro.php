...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item nvbw">
                        <a class="nav-link" href="promos.html">Conheça nossas promoções</a>
                    </li>
                    <li class="nav-item nvbw">
                        <a class="nav-link" href="maps.html">Onde nos encontrar?</a>
                    </li>
                </ul>
    ...
    <div class="container">
        ...
        <section class="bg-dark">
            <div class="container">
                <div class="row">
                        <h1 class="text-light text-center">Cadastre-se</h1>
                    <div class="col aling-self-center">
                        <div class="card exemplo border border-4 border-warning">
                            <form class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label for="validationDefaultUsername" class="form-label">Nome de Usuário</label>
                                    <div class="input-group">
                                        <span class="input-group-text" id="inputGroupPrepend2">@</span>
                                        <input type="text" class="form-control" id="validationDefaultUsername"
                                            aria-describedby="inputGroupPrepend2" placeholder="*Campo obrigatório"
                                ...
                                <div class="col-md-3">
                                    <label for="validationDefault" class="form-label">Escolha seu plano:</label>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label">
                                            Quero receber e-mails de promoções e novidades da MasterFit
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
